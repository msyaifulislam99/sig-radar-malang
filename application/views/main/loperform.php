  ...
  <div class="content-wrapper">
    ...
    <?php } ?>
      <div class="alert alert-info alert-dismissible">
        ...
        Apabila anda kesulitan untuk menentukan koordinat, silahkan klik tombol  <button type="button" class="btn btn-warning btn-sm"><i class="fa fa-map-marker"></i></button>, kemudian klik lokasi dimana Loper berada. Maka Lattitude dan Longitude akan terisi otomatis
      </div>
      <div class="row">
        <div class="col-md-12">
          <!-- Horizontal Form -->
